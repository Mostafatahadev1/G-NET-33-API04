...
namespace E_Commerce.Application.Common
{
    public sealed record Error(string Code, string Description, ErrorType ErrorType = ErrorType.Failure)
    {
        ...
        public static Error Confict(string code = "General.Confict", string description = "General  Confict Has Occured")
        ...
        public static Error InvalidCredentials(string code = "General.InvalidCredentials", string description = "Provied Credentials are Invaild")
